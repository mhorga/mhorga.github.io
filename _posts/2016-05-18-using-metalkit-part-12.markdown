...
summary: Using the same playground you worked on in part 11, you will learn how to use MSL uniforms to animate the fractal and interact with it using your touchpad or mouse.
layout: post
---
